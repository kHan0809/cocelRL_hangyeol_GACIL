...
parser.add_argument('--seed', type=int, default=123, metavar='N',help='random seed (default: 123456)')
...
#GAC parameter
parser.add_argument('--expand_batch', type=int, default=100, help='100')
parser.add_argument('--alpha'     , type=float, default=0.5 ,help ='1.0')
parser.add_argument('--alpha_min' , type=float, default=0.3, help = '1.0')
parser.add_argument('--alpha_max' , type=float, default=0.8, help = '1.8')
parser.add_argument('--beta'      , type=float, default=0.3, help = '0.3')
parser.add_argument('--beta_start', type=float, default=0.3, help = '0.3')
parser.add_argument('--beta_max'  , type=float, default=4.0, help = '4.0')
parser.add_argument('--beta_step' , type=float, default=0.01,help = '0.01')
...
for iteration in range(2,6):
    ...
    agent = GAC(env.observation_space.shape[0], env.action_space.shape[0], args)
    ...
    for t in range(total_steps):
        ...
        if (t+1) % args.steps_per_epoch == 0:
            ...
            f = open("./log" + str(iteration) + "GAC" + ".txt", 'a')
