...
for iteration in range(1,6):
    # log
    if args.log == True:
        f = open("./log" + str(iteration) + "SAC" + ".txt", 'w')
        f.close()
    ...
    for i_episode in itertools.count(1):
        ...
        while not done:
            ...
            if len(agent.buffer) > args.batch_size:
                ...
                for i in range(args.updates_per_step):
                    ...
                    critic_1_loss, critic_2_loss, policy_loss, ent_loss, alpha = agent.update_parameters(args.batch_size, updates)
        ...
        if i_episode % 10 == 0 and args.eval is True:
            ...
            f = open("./log" + str(iteration) + "SAC" + ".txt", 'a')
